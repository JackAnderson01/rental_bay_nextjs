    ...
    return (
        <div className='w-full h-auto flex flex-col gap-6 justify-start items-start'>
            ...
            <diV className="w-auto flex gap-2 justify-start items-center">
                ...
                <button className='w-36 h-10 bg-orange-500 transition-all duration-150 hover:opacity-95 text-xs font-medium flex items-center justify-center text-white uppercase'>
                    Submit
                </button>
