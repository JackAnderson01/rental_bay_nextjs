...
export default function StoreProductDescription({ params }) {
    ...
    return (
        <div className=" w-full h-auto flex flex-col gap-6 justify-start items-start px-6 lg:px-14 py-6 lg:py-10">
            ...
            <div className='w-full flex justify-start items-center gap-1'>
                <Link href="/home" className='text-[#959595] flex justify-start items-center text-sm font-semibold transition-all duration-150 hover:text-black'>
                    Home
                    ...
                    <div className='w-auto h-auto flex flex-col gap-1 justify-start items-start'>
                        ...
                        <div className='w-auto h-auto flex justify-start items-start gap-2'>
                            ...
                            <div className='w-auto flex flex-col justify-start items-start'>
                                ...
                                <Link href="/product-owner/profile" className='text-[10px] lg:text-xs font-medium hover:underline text-orange-500'>
                                    View Profile
                                </Link>
