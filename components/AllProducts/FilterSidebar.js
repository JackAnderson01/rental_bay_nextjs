    ...
    <div ref={filterRef} className="w-72 h-screen fixed top-14 left-0 -translate-x-full lg:translate-x-0 transition-all duration-200 lg:static lg:w-1/4 lg:h-auto flex flex-col justify-start items-start p-4 gap-12 bg-white lg:border-2 border-gray-200 overflow-y-auto">
                ...
                <div className="w-full h-auto flex flex-col gap-2 justify-start items-start">
                    ...
                    <div className="w-full h-auto flex justify-center items-center gap-2">
                        <input type="text" className="w-[48%] h-12 rounded-md bg-gray-100 px-3 outline-none border border-gray-300 transition-all duration-150 focus:ring-2 focus:ring-gray-300" placeholder="City" />
                        <input type="text" className="w-[48%] h-12 rounded-md bg-gray-100 px-3 outline-none border border-gray-300 transition-all duration-150 focus:ring-2 focus:ring-gray-300" placeholder="State" />
